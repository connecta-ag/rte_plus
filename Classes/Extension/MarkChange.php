<?php
namespace CAG\RtePlus\Extension;
...
class MarkChange extends \TYPO3\CMS\Rtehtmlarea\RteHtmlAreaApi {
	...
	protected $extensionKey = 'rte_plus';

	// The name of the plugin registered by the extension
	protected $pluginName = 'MarkChange';

	// Path to this main locallang file of the extension relative to the extension dir.
	protected $relativePathToLocallangFile = 'extensions/MarkChange/locallang_csh.xlf';

	// Path to the skin (css) file relative to the extension dir
	protected $relativePathToSkin = 'extensions/MarkChange/skin/htmlarea.css';
	...
	protected $pluginButtons = 'markchange';
	...
	// 	// CAG TODO: maybe remove this method again since it might not be needed?!
